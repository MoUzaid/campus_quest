...
//     if (data.length === 0) {
//       alert(`No ${type} students to export.`);
//       return;
//     }
...
//                   size="small"
//                   color="success"
//                   disabled={attemptedStudents.length === 0}
//                 >
//                   Export
//                 </Button>
//               </Stack>
...
//                   </TableRow>
//                 ) : (
//                   getPagedData(filteredRegistered, registeredPage).map((s, index) => (
//                     <TableRow 
//                       key={`registered-${s._id || index}`}
//                       hover
//                       sx={{ 
//                         '&:hover': { 
//                           bgcolor: alpha(theme.palette.primary.main, 0.02) 
...
//                   </TableRow>
//                 ) : (
//                   getPagedData(filteredAttempted, attemptedPage).map((s, index) => (
//                     <TableRow 
//                       key={`attempted-${s._id || index}`}
//                       hover
//                       sx={{ 
//                         '&:hover': { 
//                           bgcolor: alpha(theme.palette.success.main, 0.02) 
...
//                 { 
//                   label: "Member Since", 
//                   value: selectedStudent.memberSince ? format(new Date(selectedStudent.memberSince), 'dd MMM yyyy') : 'N/A',
//                   icon: <CalendarToday />
//                 },
//               ].map((field, index) => (
//                 <Grid item xs={12} sm={6} key={index}>
